...
#mkdir Zbb_NLO_9/
#pwd
#cp submit_jobs_condor.py Zbb_NLO_9/
#cp Zbb_NLO_9.lhe Zbb_NLO_9/
#cp main321 Zbb_NLO_9/
#cp main321.cmnd Zbb_NLO_9/
#cd rivet/addons
#rm -r -f FatHiggsTagging.cc
#cp ../../FatHiggsTagging.cc .
#cp ../../FatHiggsTagging.cc ../../Zbb_NLO_9/
#source make.sh
#cd ../../Zbb_NLO_9/
#ls -alrth
#pwd
#mv Zbb_NLO_9.lhe unweighted_events.lhe
...
#mv ofile.hepmc Zbb_NLO_9.hepmc
#ls -alrth
#cp Zbb_NLO_9.hepmc ../../Zbb_NLO_9
#cd ../../Zbb_NLO_9
#rivet -a FatHiggsTagging --process higgs -o Zbb_NLO_9.yoda Zbb_NLO_9.hepmc -n 25900
#yoda2root Zbb_NLO_9.yoda
#rm -f Zbb_NLO_9.hepmc
#ls -alrth
#cd ..
#ls -alrth
#echo "== done == "
...
./main321 unweighted_events.lhe
mv ofile.hepmc Zbb_NLO_9.hepmc
#mv Zbb_NLO_9.hepmc ../../Zbb_NLO_9/Events/run_01
#cd ../../Zbb_NLO_9/Events/run_01
mv Zbb_NLO_9.hepmc ../../Zbb_NLO_9
cd ../../Zbb_NLO_9
rivet -a FatHiggsTagging --process higgs -o Zbb_NLO_9.yoda Zbb_NLO_9.hepmc -n 25900
yoda2root Zbb_NLO_9.yoda
rm -f Zbb_NLO_9.hepmc
