...
#ls -alrth
#mkdir Zbb_NLO_4_decay/
#pwd
#cp submit_jobs_condor.py Zbb_NLO_4_decay/
#cp Zbb_NLO_4_decay.lhe Zbb_NLO_4_decay/
#cp main321 Zbb_NLO_4_decay/
#cp main321.cmnd Zbb_NLO_4_decay/
#cd rivet/addons
#rm -r -f FatHiggsTagging.cc
#cp ../../FatHiggsTagging.cc .
#cp ../../FatHiggsTagging.cc ../../Zbb_NLO_4_decay/
#source make.sh
#cd ../../Zbb_NLO_4_decay/
#ls -alrth
#pwd
#mv Zbb_NLO_4_decay.lhe unweighted_events.lhe
...
#mv ofile.hepmc Zbb_NLO_4_decay.hepmc
#ls -alrth
#cp Zbb_NLO_4_decay.hepmc ../../Zbb_NLO_4_decay
#cd ../../Zbb_NLO_4_decay
#rivet -a FatHiggsTagging --process higgs -o Zbb_NLO_4_decay.yoda Zbb_NLO_4_decay.hepmc -n 25900
#yoda2root Zbb_NLO_4_decay.yoda
#rm -f Zbb_NLO_4_decay.hepmc
#ls -alrth
#cd ..
#ls -alrth
#echo "== done == "
...
rm -r -f main321.cmnd
cp ../main321.cmnd .
#cd ../Zbb_NLO_4_decay/Events/run_01
cd ../Zbb_NLO_4_decay/
ls -alrth
pwd
...
./main321 unweighted_events.lhe
mv ofile.hepmc Zbb_NLO_4_decay.hepmc
#mv Zbb_NLO_4_decay.hepmc ../../Zbb_NLO_4_decay/Events/run_01
#cd ../../Zbb_NLO_4_decay/Events/run_01
mv Zbb_NLO_4_decay.hepmc ../../Zbb_NLO_4_decay
cd ../../Zbb_NLO_4_decay
rivet -a FatHiggsTagging --process higgs -o Zbb_NLO_4_decay.yoda Zbb_NLO_4_decay.hepmc -n 25900
yoda2root Zbb_NLO_4_decay.yoda
rm -f Zbb_NLO_4_decay.hepmc
